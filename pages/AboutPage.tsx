    ...
    <div className="bg-light-grey">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h1 className="font-poppins text-4xl font-bold text-deep-navy">About Bitcoin Unical</h1>
          <p className="mt-4 text-lg text-gray-600">Our journey, our mission, and what we stand for.</p>
        </div>
        ...
        {/* Timeline */}
        <div className="mb-16">
          <h2 className="text-center font-poppins text-3xl font-bold text-deep-navy mb-8">Our Milestones</h2>
            ...
            {milestones.map((item, index) => (
              <div key={index} className={`mb-8 flex justify-between items-center w-full ${index % 2 === 0 ? 'flex-row-reverse' : ''}`}>
                ...
                <div className="w-5/12 bg-white p-4 rounded-lg shadow-md">
                  <h3 className="font-poppins font-bold text-lg text-deep-navy">{item.year}</h3>
        ...
        {/* Quote Callout */}
        <div className="my-16 p-8 border-l-8 border-bitcoin-orange bg-white rounded-lg shadow-md">
          <p className="font-poppins text-2xl md:text-3xl font-semibold italic text-deep-navy">
        ...
        {/* Photo Gallery */}
        <div>
          <h2 className="text-center font-poppins text-3xl font-bold text-deep-navy mb-8">Our Community in Action</h2>
          {loading ? (
